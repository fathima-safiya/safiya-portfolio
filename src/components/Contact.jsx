...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0B1120] w-full min-h-screen relative overflow-hidden flex items-end pt-24 sm:pt-36 md:pt-48 pb-16 sm:pb-24 border-t border-white/10 select-none">
