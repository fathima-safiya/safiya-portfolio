      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-12 flex flex-col md:flex-row items-stretch md:items-end gap-10 sm:gap-14 md:gap-16 lg:gap-24">
        ...
        <div className="flex-1 flex flex-col items-start text-white">
          ...
          <div className="flex flex-col gap-5 sm:gap-6 w-full max-w-md">
            ...
            <a 
              ...
              className="flex items-center gap-4 group p-3 sm:p-4 rounded-2xl bg-white/5/50 border border-white/5 hover:bg-white/5 hover:border-sky-500/30 transition-all duration-300"
            >
            ...
            <a 
              ...
              className="flex items-center gap-4 group p-3 sm:p-4 rounded-2xl bg-white/5/50 border border-white/5 hover:bg-white/5 hover:border-[#25D366]/30 transition-all duration-300"
            >
            ...
            {/* Location */}
            <div className="flex items-center gap-4 p-3 sm:p-4 rounded-2xl bg-white/5/50 border border-white/5">
        ...
        <div className="flex-1 w-full max-w-md mx-auto md:max-w-none flex justify-end">
          <motion.div 
            ...
            className="bg-white/5/95 backdrop-blur-2xl border-t border-l border-white/15 w-full p-6 sm:p-8 md:p-12 text-white flex flex-col justify-between rounded-3xl sm:rounded-[2.5rem] shadow-[0_-15px_60px_rgba(0,0,0,0.8)] relative overflow-hidden"
          >
