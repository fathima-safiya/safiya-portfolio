      ...
      <div className="max-w-7xl mx-auto flex flex-col space-y-8 sm:space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 sm:gap-8 pb-8 sm:pb-12 border-b border-white/10">
          <div className="space-y-1.5 sm:space-y-2">
            <div className="text-xl sm:text-2xl font-black text-sky-500 tracking-tighter flex items-center gap-1.5 sm:gap-2 drop-shadow-[0_2px_15px_rgba(56,189,248,0.9)]">
          ...
          <nav className="flex flex-wrap gap-4 sm:gap-6 md:gap-8 text-xs font-mono uppercase tracking-widest text-white/70">
            <a href="#home" className="hover:text-sky-400 transition-colors py-1">Home</a>
            <a href="#about" className="hover:text-sky-400 transition-colors py-1">About</a>
            <a href="#skills" className="hover:text-sky-400 transition-colors py-1">Skills</a>
            <a href="#projects" className="hover:text-sky-400 transition-colors py-1">Projects</a>
            <a href="#contact" className="hover:text-sky-400 transition-colors py-1">Contact</a>
          </nav>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-xs sm:text-sm md:text-base font-mono text-white/60">
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            <a 
              ...
              className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-blue-900 border border-white/10 flex items-center justify-center hover:bg-sky-500/20 hover:border-sky-500/50 transition-all duration-300 shadow-lg group"
              title="GitHub"
            >
            ...
            <a 
              ...
              title="Email"
            >
              <svg className="w-5 h-5 md:w-6 md:h-6 text-white/80 group-hover:text-sky-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
