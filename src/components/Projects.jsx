        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {projectsData.map((project, i) => (
            <div
              ...
              className="group flex flex-col w-full h-full rounded-2xl sm:rounded-[24px] overflow-hidden border border-white/10 bg-[#0B1120]/90 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] hover:border-sky-500/50 hover:shadow-[0_25px_60px_rgba(56,189,248,0.15)] transition-all duration-500 hover:-translate-y-2 relative"
            >
